	...
	$.extend($.fn, {
		...
		rules : function(command, argument) {
			...
			var data = $.validator.normalizeRules($.extend( {}, $.validator.metadataRules(element), $.validator
				.classRules(element), $.validator.attributeRules(element), $.validator.staticRules(element)), element);
				...
				prototype : {
					...
					check : function(element) {
						...
						for ( var method in rules) {
							...
							try {
								var result = $.validator.methods[method].call(this, element.value.replace(/\r/g, ""),
					...
					defaultMessage : function(element, method) {
						return this.findDefined(this.customMessage(element.name, method), this.customMetaMessage(
							element, method),
...
//							alert(tip.start)
				...
				methods : {
					...
					selectRequired : function(value, element,param){
