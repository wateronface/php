<?php /* Smarty version Smarty-3.0.8, created on 2014-08-23 11:45:33
         compiled from "G:\dev\APMServ5.2.6_me\www\htdocs/tpl\product_list.htm" */ ?>
<?php /*%%SmartyHeaderCode:1527353f87edd560136-51716037%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9923592f87077bd68490d115755e5ac29bfba602' => 
    array (
      0 => 'G:\\dev\\APMServ5.2.6_me\\www\\htdocs/tpl\\product_list.htm',
      1 => 1408794332,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1527353f87edd560136-51716037',
  'function' => 
  array (
  ),
...
$(document).ready(function(){
		...
		$(".deletes").click(function(){
			...
			if(count>0){
				if(confirm("确定删除选中?")){
					$('#form1').attr('action','<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'product_action','a'=>'updateselect'),$_smarty_tpl);?>
');
		  			$('#form1')[0].submit();
				}
			}else{
