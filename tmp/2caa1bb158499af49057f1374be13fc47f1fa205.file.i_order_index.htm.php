<?php /* Smarty version Smarty-3.0.8, created on 2014-08-25 11:42:23
         compiled from "G:\dev\APMServ5.2.6_me\www\htdocs/tpl\i_order_index.htm" */ ?>
<?php /*%%SmartyHeaderCode:3184953fb211f453133-18754848%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2caa1bb158499af49057f1374be13fc47f1fa205' => 
    array (
      0 => 'G:\\dev\\APMServ5.2.6_me\\www\\htdocs/tpl\\i_order_index.htm',
      1 => 1408966940,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3184953fb211f453133-18754848',
  'function' => 
  array (
  ),
...
');
		...
		$(".instocks").click(function(){
			var count = $("input[name='chk_list[]']:checked").length;
			if(count==1){
				$('#form1').attr('action','<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'i_instock_action','a'=>'addform'),$_smarty_tpl);?>
');
		  		$('#form1')[0].submit();
			}else{
				alert("请选中唯一一条记录");
...
"><li class="updates"><span><img src="images/t02.png" /></span>修改</li></a>
        ...
        <a href="#"><li class="instocks"><span><img src="images/t08.png" /></span>入库</li></a>
