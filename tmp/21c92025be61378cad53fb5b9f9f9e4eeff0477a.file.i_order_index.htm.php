<?php /* Smarty version Smarty-3.0.8, created on 2014-08-31 07:17:52
         compiled from "E:\php/tpl\i_order_index.htm" */ ?>
<?php /*%%SmartyHeaderCode:116945402cc208156f5-10279728%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '21c92025be61378cad53fb5b9f9f9e4eeff0477a' => 
    array (
      0 => 'E:\\php/tpl\\i_order_index.htm',
      1 => 1409469351,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '116945402cc208156f5-10279728',
  'function' => 
  array (
  ),
...
$(document).ready(function(){
		...
		$(".deletes").click(function(){
			...
			if(count>0){
				if(confirm("确定删除选中?这将会同时删除关联的打款、入库、发票等数据")){
...
"><li><span><img src="images/t01.png" /></span>添加</li></a>
        ...
        <form id="form_search"  action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'i_order_action','a'=>'index'),$_smarty_tpl);?>
" method="post">
...
" /></li>
    ...
    <form id="form1" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'i_order_action','a'=>'deleteselect'),$_smarty_tpl);?>
" method="post">
