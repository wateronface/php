<?php /* Smarty version Smarty-3.0.8, created on 2014-08-31 08:01:42
         compiled from "E:\php/tpl\i_invoice_index.htm" */ ?>
<?php /*%%SmartyHeaderCode:127125402d666d3f866-46165701%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '80bf47515b52cbc01503debac9118d7d7d64ccfa' => 
    array (
      0 => 'E:\\php/tpl\\i_invoice_index.htm',
      1 => 1409449808,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '127125402d666d3f866-46165701',
  'function' => 
  array (
  ),
...
$(document).ready(function(){
		...
		$(".deletes").click(function(){
			...
			if(count>0){
				if(confirm("确定删除选中?")){
					$('#form1').attr('action','<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'i_invoice_action','a'=>'deleteselect'),$_smarty_tpl);?>
');
		  			$('#form1')[0].submit();
				}
			}else{
...
<body>
    ...
    <div class="tools">
    	 <ul class="toolbar">
        <!--a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'i_invoice_action','a'=>'addform'),$_smarty_tpl);?>
