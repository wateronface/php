...
class spController { 
	...
	public function alert($data){
		echo "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><script>function sptips(){alert(\"$data\")};</script></head><body onload=\"sptips()\"></body></html>";
	}
